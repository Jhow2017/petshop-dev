                ...
                <div className="relative">
                    <div className="overflow-hidden" ref={emblaRef}>
                        <div className="flex">
                            {services?.map((item, index) => (
                                <div
                                    key={index}
                                    className="flex-[0_0_100%] cursor-pointer select-none min-w-0 md:flex-[0_0_calc(100%/3)] px-3"
                                >
                                    <article className=" bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                        ...
                                        <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                                            ...
                                            <a
                                                href="#"
                                                className="flex items-center justify-between gap-2 hover:bg-red-500 px-4 py-1 rounded-md duration-300"
                                            >
                    ...
                    <button
                        ...
                        className="
                            ...
                            rounded-full shadow-lg w-10 h-10 absolute left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
                    >
                    ...
                    <button
                        ...
                        className="
                        bg-white flex items-center justify-center 
                        rounded-full shadow-lg w-10 h-10 absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
                    >
